...
function listenAtTopLevel(touchNotMouse) {
  ...
  if (touchNotMouse) {
    if (window.navigator.msPointerEnabled) {
      trapBubbledEvent(topLevelTypes.topPointerDown, 'MSPointerDown', mountAt);
      trapBubbledEvent(topLevelTypes.topPointerUp, 'MSPointerUp', mountAt);
      trapBubbledEvent(topLevelTypes.topPointerMove, 'MSPointerMMove', mountAt);
      trapBubbledEvent(topLevelTypes.topPointerOver, 'MSPointerOver', mountAt);
      trapBubbledEvent(topLevelTypes.topPointerOut, 'MSPointerOut', mountAt);
      trapBubbledEvent(topLevelTypes.topPointerHover, 'MSPointerHover', mountAt);
    } else { 
...
var eventTypes = {
  ...
  pointerHover: {
    phasedRegistrationNames: {
      bubbled: keyOf({onPointerHover: true}),
      captured: keyOf({onPointerHoverCapture: true})
    }
  },
  pointerMove: {
    phasedRegistrationNames: {
...
var topLevelEventsToDispatchConfig = {
  ...
  topPointerHover: eventTypes.pointerHover,
...
var SimpleEventPlugin = {
  ...
  extractEvents: function(
    ...
    switch(topLevelType) {
      ...
      case topLevelTypes.topPointerHover:
      case topLevelTypes.topPointerOver:
        EventConstructor = SyntheticTouchEvent;
        break;
